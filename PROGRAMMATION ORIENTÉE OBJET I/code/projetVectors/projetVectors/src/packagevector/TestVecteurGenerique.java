...
public class TestVecteurGenerique {

    public static void main(String[] args)
    {
        // Création d'un vecteur avec générique: plus besoin de transtiper car le systeme sait que ce sont des points
...
//        System.out.println(s1.getX());
        ...
        System.out.println(v.get(0).getX());
