...
static void TestLocation() {
	...
	Client_s majClient = { "Plante", "Valerie", "5148820311", { 275, "Notre Dame E", "Montreal", "H2Y1C6" }, Aujourdhui(), 1, { {2, location, retour}, {}, {} } };
...
static void TestRetour() {
	...
	Client_s client1 = { "Plante", "Valerie", "5148820311", { 275, "Notre Dame E", "Montreal", "H2Y1C6" }, Aujourdhui(), 2, { {0, location, retour}, {1, location, retour}, {} } };
	Client_s client2 = { "Plante", "Valerie", "5148820311", { 275, "Notre Dame E", "Montreal", "H2Y1C6" }, Aujourdhui(), 1, { {1, location, retour}, {}, {} } };
	Client_s client3 = { "Plante", "Valerie", "5148820311", { 275, "Notre Dame E", "Montreal", "H2Y1C6" }, Aujourdhui(), 0, { } };

	pointage += (int)(roundUp(Retour(2, 2, AjouterJours(retour, 2))) == 11.5);
	resultCorrection << "\tRetour effectué pour le livre {Petit guide de survie des chômeurs et chômeuses, Comité Chômage de Montréal} (avec bon frais de retard) : "
		<< (roundUp(Retour(2, 2, AjouterJours(retour, 2))) == 11.5) << "/1\n";
	...
	pointage += (int)(roundUp(Retour(2, 1, AjouterJours(retour, -3))) == 0);
	resultCorrection << "\tRetour effectué pour le livre {Un guide galactique, Douglas Adam} (retour en avance) : "
		<< (roundUp(Retour(2, 1, AjouterJours(retour, -3))) == 0) << "/1\n";
